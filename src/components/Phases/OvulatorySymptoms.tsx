const OvulatorySymptoms = () => {
    return (
      <div className="container_info_phases">
        ...
        <ul className="mt-4 list-disc pl-5 space-y-2 leading-relaxed text-white">
          ...
          <li className="pl-2">Sensibilidad en los senos<sup className="text-sm">1</sup></li>
          <li className="pl-2">Hinchazón o retención de líquidos<sup className="text-sm">1</sup></li>
          <li className="pl-2">Dolor leve en uno de los lados del abdomen (dolor mittelschmerz)<sup className="text-sm">1</sup></li>
  ...
  export default OvulatorySymptoms;
